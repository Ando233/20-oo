...
public class Check {
    ...
    public boolean checkBuyTicket(String ...args){
        ...
        if(seat.equals("1A") || seat.equals("2A")){
            if(!Cert.Certs.containsKey(User.nowUserId) || Cert.Certs.get(User.nowUserId)){
    ...
    public boolean checkRecharge(String ...args){
        int len = args.length;
        if(len != 2){
            System.out.println("Arguments illegal");
            return false;
    ...
    public boolean checkCheckBalance(String ...args){
        int len = args.length;
        if(len != 1){
            System.out.println("Arguments illegal");
            return false;
    ...
    public boolean checkImport(int userMode, String ...args){
        if(userMode == 0){
            System.out.println("Command does not exist");
            return false;
        }
    ...
    public boolean checkCancelOrder(String ...args){
        int len = args.length;
        if(len != 6){
            System.out.println("Arguments illegal");
            return false;
    ...
    public boolean checkPayOrder(String ...args){
        int len = args.length;
        if(len != 1){
            System.out.println("Arguments illegal");
            return false;
